...
#PHOTO icon bitmap--- not working _ did install/import PIL
...
confirm_code = Entry(frame, text= "Confirm password", width=25, fg='black', border=0,bg='white', font=('Helvetica',11))
...
###--------------------------------------------------------------
Button(frame, text="Sign IN", width=39, pady=7, bg="blue", fg= "white", border=0).place(x=35, y=280)

label=Label(frame, text="I have an account", fg = 'black', bg = 'white', cursor='hand2', font=('Helvetica',9))
label.place(x=90,y=340)

sign_In=Button(frame, text="Sign Up", width=6, border=0, bg="white", cursor='hand2', fg="blue")
